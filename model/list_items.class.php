...
//    var $editIcon = <<<EOF
//<img class="icon" src="/resources/bootstrap-icons-1.4.0/pencil-square.svg" alt="edit" width="14" />
//EOF;
...
EOF;
//    static public $unAvailable = '<span class="glyphicon glyphicon-thumbs-down"></span>';
...
//        $editIcon = self::$editIcon;
        $formatedItems = [];
//        Debug::dump($this->list, 'list in ' . __METHOD__ . ' line ' . __LINE__);
        foreach ($this->list as $key => $item) {
